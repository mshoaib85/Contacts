		...
		<div class="row">
			<form action="" method="post" class="col-md-12"  enctype="multipart/form-data">
				<div class="sigle-input col-md-12">
					...
					<input class="col-md-8" type="text" name="name" placeholder="Muhammad Shoaib Majeed">
				</div>
				<div class="sigle-input col-md-12">
					<label class="col-md-3">Phone No: *</label>
					<input class="col-md-8" type="text" name="phone" placeholder="03214584057">
				</div>
				<div class="sigle-input col-md-12">
					<label class="col-md-3">Email: </label>
					<input class="col-md-8" type="email" name="email" placeholder="abc@gmail.com">
				</div>
				<div class="sigle-input col-md-12">
					<label class="col-md-3">Address: </label>
					<input class="col-md-8" type="text" name="address" placeholder="Lahore , Pakistan">
				</div>
				<div class="sigle-input col-md-12">
...
if (isset($_POST['submit'])) {
	...
	$uploadDir = '/contact/img/uploaded/';
