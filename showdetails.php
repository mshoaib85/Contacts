...
<?php } ?>
		...
		<div class="row">
			<form action="" method="post" class="col-md-12" enctype="multipart/form-data">
				<div class="sigle-input col-md-12">
					...
					<input class="col-md-8" type="text" name="name" placeholder="Md Mortuza Hossain" value="<?php echo $result['name']; ?>">
				</div>
				<div class="sigle-input col-md-12">
					<label class="col-md-3">Phone No: </label>
					<input class="col-md-8" type="text" name="phone" placeholder="01719200957" value="<?php echo $result['phone']; ?>">
				</div>
				<div class="sigle-input col-md-12">
					<label class="col-md-3">Email: </label>
					<input class="col-md-8" type="email" name="email" placeholder="demo@gmail.com" value="<?php echo $result['email']; ?>">
				</div>
				<div class="sigle-input col-md-12">
					<label class="col-md-3">Address: </label>
					<input class="col-md-8" type="text" name="address" placeholder="Dhaka , Bangladesh" value="<?php echo $result['address']; ?>">
				</div>
				<div class="sigle-input col-md-12">
	...
	if (isset($_POST['update'])) {
		...
		$uploadDir = '/contacts/img/uploaded/';
	...
	<div class="container text-center "> <!--  fixed-bottom -->
		<dir class="row">
			<dir class="col-md-12 footer">
				<p class="col-md-12">Application Developed By <a href="http://www.facebook.com/mdmortuza.hossain/">Md Mortuza Hossain</a></p>
			</dir>
		</dir>
	</div>
	
	<div class="fixedicon">
        <a href="http://www.facebook.com/mdmortuza.hossain/"><img src="img/fb.png" alt="Facebook"/></a>
    </div>
